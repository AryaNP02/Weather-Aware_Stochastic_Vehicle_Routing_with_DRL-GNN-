...
from src.agents.routing_policy import RoutingAgent
from src.trainers.policy_gradient import PolicyGradientTrainer
from src.solvers.search_strategies import GreedyInference, RandomSamplingInference, BeamSearchInference
...
def execute_training_run(args, env, trainer, logger, val_dataset):
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        if epoch % args.save_interval == 0:
            ...
            if args.test_size > 0: 
                 ...
                 eval_reward = execute_evaluation_run(args, env, trainer.policy_model, 
...
def execute_evaluation_run(args, env, policy_model, num_instances, logger, dataset=None, is_interim_eval=False):
...
def main():
    ...
    if not args.test_only:
        execute_training_run(args, env, trainer, logger, val_dataset)
    ...
    if args.test_size > 0:
        ...
        execute_evaluation_run(args, env, policy_model, args.test_size, logger, dataset=val_dataset)
    else:
